    ...
    <div class="admin-layout">
        ...
        <div class="admin-sidebar">
            <div
                ...
                ADMIN PANEL</div>
            <h3>Main</h3>
            <a href="admin.php?tab=dashboard" class="sidebar-link <?= $tab === 'dashboard' ? 'active' : '' ?>">Dashboard</a>
                
            <h3>Management</h3>
            <a href="admin.php?tab=movies" class="sidebar-link <?= $tab === 'movies' ? 'active' : '' ?>">Movies</a>
            <a href="admin.php?tab=bookings" class="sidebar-link <?= $tab === 'bookings' ? 'active' : '' ?>">Bookings</a>
                
            <a href="admin.php?tab=users" class="sidebar-link <?= $tab === 'users' ? 'active' : '' ?>">Users</a>
            <a href="admin.php?tab=showtimes" class="sidebar-link <?= $tab === 'showtimes' ? 'active' : '' ?>">Showtimes</a>
        ...
        <div class="admin-main">
            ...
            <?php if ($tab === 'dashboard'): ?>
                <!-- ===== DASHBOARD ===== -->
                <h1 style="font-family:'Bebas Neue',cursive;font-size:2rem;letter-spacing:3px;margin-bottom:1.5rem;">Dashboard</h1>
                        ...
                        <tbody>
                            ...
                            while ($m = $mv->fetch_assoc()): ?>
                                <tr>
                                    ...
                                    <td>
                                        <div class="movie-cell">
                                            <?php if (!empty($m['poster']) && file_exists($m['poster'])): ?>
                                                <img src="<?= htmlspecialchars($m['poster']) ?>" alt="<?= htmlspecialchars($m['title']) ?>" class="movie-thumb">
                                            <?php else: ?>
                                    ...
                                    <td style="color:var(--text-dim);font-size:0.82rem;"><?= htmlspecialchars($m['genre']) ?></td>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td style="font-size:0.8rem;">
                                        <?php if ($b['vip_count'] > 0): ?><span
                                                style="color:var(--gold);">VIP <?= $b['vip_count'] ?></span><?php endif; ?>
                        ...
                        <tbody>
                            ...
                            while ($u = $us->fetch_assoc()): ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php if ($u['is_admin']): ?>
                                            <span class="status-badge" style="background:rgba(245,197,24,0.15);color:var(--gold);">Admin</span>
