...
// ดึงที่นั่งที่จองแล้ว (ป้องกันซ้ำ - lock ด้วย DB)
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($seats_arr)) {
        ...
        // ===== ป้องกันที่นั่งซ้ำ ด้วย Transaction =====
...
$total_seats = $showtime['total_seats']; // ดึงจาก DB
